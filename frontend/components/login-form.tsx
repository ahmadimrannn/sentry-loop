...
import { signInWithEmail, signInWithSocial } from "@/app/auth/sign-in/actions";
      ...
      <FieldGroup>
        ...
        <Field className="flex flex-col gap-2">
          ...
          >
            {oauthPending ? (
              <>
                <div className="animate-spin h-4 w-4 mr-2 rounded-full border-2 border-gray-400 border-t-gray-900" />
                Signing in...
              </>
            ) : (
              <>

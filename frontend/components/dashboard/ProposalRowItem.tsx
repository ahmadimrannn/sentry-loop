...
export function ProposalRowItem({ proposal, formatDate }: ProposalRowItemProps) {
  ...
  return (
    <>
      ...
      {expanded && (
        <TableRow className="bg-neutral-50/70 dark:bg-neutral-900/40 hover:bg-neutral-50/70">
          <TableCell colSpan={5} className="p-4 space-y-3">
            <div className="space-y-1">
              <h4 className="text-xs font-semibold text-foreground">Investigation Summary</h4>
            ...
            <div className="space-y-1">
              <h4 className="text-xs font-semibold text-foreground">Proposed Fix</h4>
